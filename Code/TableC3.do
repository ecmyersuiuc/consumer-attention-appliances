// do /Users/shoude/Dropbox/eegap/EEgap_scripts/Exploration_Product_Assortment.do

// Dependency
// do /Users/shoude/Dropbox/eegap/EEgap_scripts/Exploration_Choice_Set.do
...
cd $pathresults/`result_assortment'
 esttab t_1_* using "Table_paper_assortment_spec1_cluster_zip.tex", replace se
...
cd $pathresults/`result_assortment'
 esttab t_2_* using "Table_paper_assortment_spec2_cluster_zip.tex", replace se
...
cd $pathresults/`result_assortment'
 esttab t_3_* using "Table_paper_assortment_spec3_cluster_zip.tex", replace se

//do  \\fs02\d01\SHoude\EEgap\EEgap_scripts\Process_Dsire_2009.do 
...
insheet using $pathname\rebate\DSIRE_rebate_refrigerators_2009.csv, clear
save $pathname\rebate\DSIRE_rebate_refrigerators_2009, replace
...
destring high, replace force
	...
	merge utility_name using $pathname\rebate\utility_name_refrigerator_rebate_2007_2008_2013
 	tab _m
 	drop if _m==2
 	drop _m
...
insheet using $pathname\rebate\utility_name_refrigerator_rebate_2009_03092013.csv, clear
	keep if merge1==1
	keep utility_name* 
	ren utility_name2 utility_name2009
	sort utility_name 
save $pathname\rebate\utility_name_refrigerator_rebate_2009_03092013, replace

	
use $pathname\rebate\utility_name_refrigerator_rebate_2007_2008_2013, clear
	sort utility_name
merge utility_name using  $pathname\rebate\utility_name_refrigerator_rebate_2009_03092013
    tab _m
 	drop _m
	sort utility_name 
save $pathname\rebate\utility_name_refrigerator_rebate_2007_2008_2009_2013, replace
	

use $pathname\rebate\DSIRE_rebate_refrigerators_2009, clear
...
save $pathname\rebate\DSIRE_rebate_2009_cleaned, replace
...
pause
	...
	sort county_utility
save $pathname\rebate\DSIRE_rebate_week_county_2009, replace

	replace state="CO" if state==""
	collapse(mean) incentive,by(state week year)
	sort state
save $pathname\rebate\DSIRE_rebate_week_state_2009, replace

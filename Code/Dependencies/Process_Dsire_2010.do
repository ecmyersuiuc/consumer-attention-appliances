//do \\fs02\d01\SHoude\EEgap\EEgap_scripts\Process_Dsire_2010.do 
...
insheet using $pathname\rebate\DSIRE_rebate_refrigerators_2010.csv, clear
save $pathname\rebate\DSIRE_rebate_refrigerators_2010, replace

keep if residential=="TRUE"
keep if incentive_type=="Utility Rebate Program" |  incentive_type=="Local Rebate Program" 
...
destring high, replace force
	...
	merge utility_name using $pathname\rebate\utility_name_refrigerator_rebate_2007_2008_2009_2013
 	tab _m
 	drop if _m==2
 	drop _m
 	replace utility_name=utility_name2007 if utility_name2007!=""
 	replace utility_name=utility_name2008 if utility_name2008!=""
 	replace utility_name=utility_name2009 if utility_name2009!=""
...
// 	
//manually process	
 	br utility_name id merge1 if id==1
...
insheet using $pathname\rebate\utility_name_refrigerator_rebate_2010_03092013.csv, clear
	keep if merge1==1
	keep utility_name* 
	ren utility_name2 utility_name2010
	sort utility_name 
save $pathname\rebate\utility_name_refrigerator_rebate_2010_03092013, replace

	
use $pathname\rebate\utility_name_refrigerator_rebate_2007_2008_2009_2013, clear
	sort utility_name
merge utility_name using  $pathname\rebate\utility_name_refrigerator_rebate_2010_03092013
    tab _m
 	drop _m
	sort utility_name 
save $pathname\rebate\utility_name_refrigerator_rebate_2007_2008_2009_2010_2013, replace
	

use $pathname\rebate\DSIRE_rebate_refrigerators_2010, clear
	merge utility_name using $pathname\rebate\utility_name_refrigerator_rebate_2007_2008_2009_2010_2013
 	tab _m
 	drop if _m==2
 	drop _m
 	replace utility_name=utility_name2010 if utility_name2010!=""
...
save $pathname\rebate\DSIRE_rebate_2010_cleaned, replace
...
pause
	...
	sort county_utility
save $pathname\rebate\DSIRE_rebate_week_county_2010, replace

	replace state="CO" if state==""
	collapse(mean) incentive,by(state week year)
	sort state
save $pathname\rebate\DSIRE_rebate_week_state_2010, replace
